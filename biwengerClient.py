...
class BiwengerClient:
    ...
    def make_request(self, url, method='GET', need_headers=True, query_params=None, body=None):
    ...
    def full_board(self):
        return self.make_request(f'https://biwenger.as.com/api/v2/league/{self._x_league}/board?offset=0&limit=500') + \
               self.make_request(f'https://biwenger.as.com/api/v2/league/{self._x_league}/board?offset=500&limit=500')
    ...
    def market(self):
        return self.make_request('https://biwenger.as.com/api/v2/market')
